...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='ordermodel',
            name='promo_code',
            field=models.ForeignKey(blank=True, help_text='promo code that would give discount for an order', null=True, on_delete=django.db.models.deletion.CASCADE, to='orders.promocodemodel', verbose_name='promo code'),
        ),
    ]
